...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'مارسيلو') {  //WESO#0001
      msg.reply('**مارسيلو مات**');  //WESO#0001
    }
  });
...
client.on('message', msg => {  //WESO#0001
  ...
  client.on("message", message => {  //WESO#0001
    if(message.content.startsWith(prefix + 'mars')) {  //WESO#0001
...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' -help',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,'Marselo Is The Best ','Just Do It'];
    var i = -1;
    var j = 0;
